...
class AdyenGivingSubscriber implements EventSubscriberInterface
{
    ...
    public function onCheckoutFinishPageLoaded(CheckoutFinishPageLoadedEvent $event)
    {
        ...
        $backgroundImageUrl = $this->configurationService->getAdyenGivingBackgroundUrl($salesChannelId, $context);
        $charityLogoUrl = $this->configurationService->getAdyenGivingCharityLogo($salesChannelId, $context);
