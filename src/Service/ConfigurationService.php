...
class ConfigurationService
{
     ...
     * @return mixed
     */
    public function getPayPalButtonNumberOfInstallmentsForMexico(?string $salesChannelId = null)
    {
        return $this->systemConfigService->get(
     ...
     * @return mixed
     */
    public function getPayPalButtonNumberOfInstallmentsForBrazil(?string $salesChannelId = null)
    {
        return $this->systemConfigService->get(
