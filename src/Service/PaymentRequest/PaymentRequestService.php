...
class PaymentRequestService
{
    ...
    public function __construct(
        ...
        private readonly RivertyDeviceFingerprintParamsProvider $rivertyFingerprintParamsProvider,
    ...
    protected function setDeliveryAddress(
        ...
        $shippingState = $shippingAddress->getCountryState()?->getShortCode() ?? 'n/a';
        ...
        $addressInfo->setCountry($shippingAddress->getCountry()?->getIso());
    ...
    protected function setBillingAddress(
        ...
        $billingState = $billingAddress->getCountryState()?->getShortCode() ?? 'n/a';
        ...
        $addressInfo->setCountry($billingAddress->getCountry()?->getIso());
    ...
    protected function setShopperData(
        ...
        $shopperDob = $stateData['dateOfBirth'] ??
            ($customer->getBirthday()?->format('Y-m-d') ?? '');
    ...
    /**
     * Set company data on payment request
     *
     * @param IntegrationPaymentRequest $paymentRequest
